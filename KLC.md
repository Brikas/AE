...
- **Needs to Learn**
	...
	- *From Push*
		- TODO Learn about [[Project Management]]
		  background-color:: green
		- TODO Learn about [[Organisational Politics]]
		  id:: 65c3f98c-d7f0-41ae-a7e3-bd64b6239a90
		  background-color:: green
		- TODO Learn about [Complexities]([[Complexity]]) of managerial decision-making
		  background-color:: green
		- TODO Learn about [[Relationships]] in organizational settings
		  background-color:: green
		- TODO What if and org does not want [[Leadership]]?
		  background-color:: green
		- TODO Doing [[Social Movements]]
		  background-color:: green
		- **Tasks and challenges facing [[Knowledge workers]] and [[Knowledge work]]**
			- TODO Organizing work as a series of diverse and challenging projects
			  background-color:: green
			- TODO Managing project portfolios
			  background-color:: green
			- TODO [[Negotiating]] work tasks with experts, professionals, and knowledge workers.
			  background-color:: green
			- TODO [[Maintaining integration]] in very diverse workplaces
			  background-color:: green
			- TODO Grappling with [[uncertainty]] and change
			  background-color:: green
- **Topics**
	- [[Social Movements]]
	- [[What is Leadership?]]
